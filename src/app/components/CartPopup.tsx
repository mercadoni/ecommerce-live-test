...
export default function CartPopup({
  ...
  onClose: () => void;
  selectedCurrency: { code: string, symbol: string, flag: string, name: string };
}) {
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50" >
      <div className="flex flex-col items-center justify-center w-1/2 p-4 bg-white rounded-lg">
        ...
        <div className="flex justify-between w-full">
          ...
          <button className="mt-6 px-4 py-2 text-lg font-bold text-white bg-red-800 rounded-lg" onClick={onClose}>Close</button>
          <button
